...
| 芯片类型 | 适用机型 | 下载链接 |
|:---|:---|:---|
| **Apple Silicon (ARM64)** | MacBook Air/Pro M1/M2/M3/M4 等 | [📥 下载 CaffeineBar-arm64.zip](https://github.com/youngyang1024/CaffeineBar/tree/main/build) |
| **Intel (x86_64)** | 2020 年及之前的 Mac | [📥 下载 CaffeineBar-x86_64.zip](https://github.com/youngyang1024/CaffeineBar/tree/main/build) |
